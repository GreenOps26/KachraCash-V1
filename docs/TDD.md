...
# Run database integration tests against Neon test database
pnpm run test:integration

# Run full workspace test suite with coverage
...
import { assignPickupOrder, completeDoorstepSettlement, processPayoutWebhook } from '../../services/wallet-service';
